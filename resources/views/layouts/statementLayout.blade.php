...
<div class="container-fluid invoice-container">
    ...
    <header>
        <div class="row align-items-center">
            ...
            <div class="col-sm-5 text-center text-sm-right">
                <h4 class="text-7 mb-0">@yield('statementName')</h4>
            </div>
        </div>
        <hr>
    </header>
    ...
    <footer class="text-center mt-4">
        <p class="text-1"><strong>NOTE :</strong> This is computer generated Statement and does not require physical signature.</p>
